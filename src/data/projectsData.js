export const projectsData = [
  //─── Project 1: Ghurni ───
  {
    ...
    challenges: "Implementing session-based token for protecting route across both Next.js server components and Express.js API was tricky. Route ordering in Express (advertised route before :id), CORS configuration on Vercel deployment, and real-time countdown timers synced with departure dates were key challenges. Dark/light mode with transparent navbar on scroll also required careful state management.",
    futurePlans: "Live seat map for bus routes, SMS notifications for booking updates, and React Hook Form for better form validation.",
  },
  // ─── Project 2: StudyNook ───
  {
    id: 2,
